...
- **Test files**: `test_sse_filters.py` (33 tests, pure unit, no DB), `test_users.py` (4 tests, needs test DB), `test_offline_mode.py` (11 tests, pure unit), `test_organizer_access.py` (15 tests, pure unit, no DB)
...
- **Tests**: 65 unit tests + 1 ignored benchmark + 3 ignored doc-tests
