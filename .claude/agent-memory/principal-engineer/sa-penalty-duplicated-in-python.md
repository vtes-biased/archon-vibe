...
The standings_adjustment (SA) VP penalty / GW-flip / TP-rerank rule is **single-sourced in the Rust engine** as of pst #67's follow-up. Do not re-implement it in Python.
