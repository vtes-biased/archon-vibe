    ...
    <div class="flex gap-2">
      {#each themes as t}
        ...
        <button
          ...
          class="flex items-center gap-2 px-3 py-2 rounded text-sm transition-colors {active ? 'bg-accent-strong text-white' : 'bg-surface-hover text-ink hover:bg-surface-active'}"
        >
    ...
    <div class="flex gap-2 flex-wrap">
      {#each locales as locale}
        ...
        <button
          ...
          class="flex items-center gap-1.5 px-3 py-2 rounded text-sm transition-colors {active ? 'bg-accent-strong text-white' : 'bg-surface-hover text-ink hover:bg-surface-active'}"
        >
