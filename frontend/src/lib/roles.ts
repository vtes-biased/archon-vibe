...
// Roles render as their stored value except where the two diverge. The stored value "Judgekin" is
// DISPLAYED AS "Sheriff": renaming the value would mean a data migration during a live parallel run, for a badge.
