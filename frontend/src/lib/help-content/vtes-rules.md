...
> **ADVANCED RULES**\
> A second Methuselah could contest control of the vampire (see [**Contested Cards**](#Contested-cards)), 
...
back to the blood bank (see [**Influence Phase**](#influence-phase)).
...
See the [**Quick Reference**](#quick-reference) page
...
(see [**Requirements for Playing Cards**](#requirements-for-playing-cards)).
...
> (or can be retrieved as described in traits: [**Red List**](#red-list)).
...
**Action cards:** A ready unlocked (see [**Important Terms of the Game**](#important-terms-of-the-game))
...
referendum [**to gain a vote**](#political-action-cards).
...
each Methuselah, the Methuselah to your left is your prey <span class="text-crimson-400">❶</span>. They are
the Methuselah you hope to oust from the game. The Methuselah to your
right is your predator <span class="text-crimson-400">❷</span>. They are the Methuselah who hopes to oust
...
blood bank <span class="text-crimson-400">❹</span>. The number of blood counters in the blood bank can never
run out, just use additional counters, coins, stones etc as needed.

**The Edge**

The Edge <span class="text-crimson-400">❺</span> begins the game uncontrolled and is placed in the central
area as well.

**Play Area**

The area in front of each Methuselah is divided into two regions: the
uncontrolled region <span class="text-crimson-400">❻</span>, and the controlled region <span class="text-crimson-400">❼</span>. The controlled
region is further divided into two areas: the ready region <span class="text-crimson-400">❽</span> and the
torpor region <span class="text-crimson-400">❾</span>. Torpor is a special area for wounded vampires. As the
...
in front of you. Draw the top seven library cards to form your hand <span class="text-crimson-400">⓬</span>
and deal the top four crypt cards face down into your uncontrolled
region <span class="text-crimson-400">❻</span>. You can look at the cards in your hand and in your
...
> baron of a particular city (see [**Vampiric Sects**](#vampire-sects)).
...
> actions than normal (see [Master Cards](#master-cards)).
...
(see [**Resolve Any Block Attempts**](#resolve-any-block-attempts)).
...
> depending on their targets (see [**Who May Attempt to Block**](#who-may-attempt-to-block)).\
> \
...
> a Ⓓ symbol as a reminder that the action is typically directed. If
...
action (see [**Minion Cards**](#minion-cards)).
...
vampire (see [**Diablerie**](#diablerie)).
...
announced until the action succeeds (see [**The Political Action**](#the-political-action)).
...
action or when a blood hunt is called (see [**The Blood Hunt**](#the-blood-hunt)).
...
holding one of the titles listed above (see [**Other Vampire Sects**](#other-vampire-sects)).
...
dodges are also considered strikes (see [**Strike Effects**](#strike-effects)).
...
for a few special cases (see [**Strike Effects**](#strike-effects)).
...
other means), they must burn blood or life, as appropriate (see [**Damage Resolution**](#damage-resolution)).
...
strike (see [**First Strike**](#first-strike)). A
...
first strike (see [**First Strike**](#first-strike)), and
...
> card text by a merged <span class="vtes-d">&micro;</span> icon.
>
...
(see [**Contested Titles**](#contested-titles))
...
or if their title is contested (see [**Contested Titles**](#contested-titles)),
...
and Inner Circle titles are unique (see [**Contested Titles**](#contested-titles))
...
regent is unique (see [**Contested Titles**](#contested-titles)).
...
clan (see [**Contested Titles**](#contested-titles)).
...
"(limited)" card text. (See [**Bleed**](#bleed)
and [**Additional Strikes**](#additional-strikes)).
...
(see [**Contested Cards**](#contested-cards)).
...
Conviction <span class="vtes-d">&curren;</span> is a new card type. It is played in the unlock phase, so it
...
Power <span class="vtes-d">&sect;</span> is a new minion card type, only playable by imbued. An imbued may
...
may burn an incapacitated imbued and take their equipment as a Ⓓ
