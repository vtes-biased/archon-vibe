<script lang="ts">
  ...
  // Active state = amber; idle = neutral. Same icon always, colour conveys state.
  const active = "text-amber-400 hover:text-ash-400";
  const idle = "text-ash-500 hover:text-amber-400";
</script>
