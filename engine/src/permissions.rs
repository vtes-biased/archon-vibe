...
pub const CAPABILITIES: &[Rule] = &[
    ...
    Rule {
        capability: Capability::ViewSanctionReason,
        name: "view_sanction_reason",
        global: &[IC, Ethics, Rulemonger],
        same_country: &[NC],
        self_service: true,
        organizer: true,
        deny: "You don't have permission to see this sanction's reason",
        deny_scope: None,
    },
    Rule {
