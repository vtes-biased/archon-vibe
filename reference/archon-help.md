...
Users who create an account on the Archon have access to limited information: the list of upcoming VTES events and a limited list of VEKN representatives known as National Coordinators (NC) and Princes, together with their contact information.
...
The Inner Circle is the administrative board of the VEKN, and consists of distinct roles determined an appointed by the Chairman. The current Inner Circle is:

- **Chairman:** Hugh Angseesing
- **Community & Social:** Henrik Klippstrom
- **Rules & Ratings:** Vincent Ripoll
- **Website:** Gines Quinonero
...
- Being a contact new players can reach out to when in search for other players, cards to trade, or information about VTES.
- Representing their players, and being available to them as their representative
- Maintaining an open and welcoming community of VTES players in their area
- Organizing regular open sessions
- Organizing public demos and tournaments in their area, at stores, conventions, or in public places.
- Maintaining and improving relationship with local retailers
- Promoting VTES in every way possible
- Sponsoring new VEKN members, registering and protecting their personal information
...
Official VEKN Judges are VTES players recognized for their knowledge of the game rules, tournament rules, Judges guidelines, and cards rulings. They should be preferred as Judges in VEKN sanctionned tournaments, although *for now*, there is no obligation for a tournament judge to be an official VEKN judge. Official Judges make themselves available to events organizers (Princes and NCs) to act as tournament judges when needed. Check out the [Judges Guide](/document/judges-guide.html) for more information.

#### Ethics Commitee

The VEKN Ethics Committee is appointed by the VEKN Chairman. Its responsibilities and procedures are detailed in the [VEKN Code of Ethics](/document/code-of-ethics.html).

### Personal Information

Users of the Archon can register their personal information, like their name, e-mail, various social networks identifiers, as well as the deck lists they use in tournaments. This information is made available to VEKN members under conditions detailed below, and users have a right to access, modify and delete it as they wish.
...
Their **contact information**, e-mail and social networks identifiers, is only accessible to Princes and NCs in their country, except if they're a Prince or NC themselves, in which case their contact information is made publicy available as part of their responsibilities.
...
- **Judges & Organizers:** List of judges and organizers who will have access to the Tournament Management console.
...
Players can also drop, or be dropped, from the players list at any time. They still appear in the list of players for the event to avoid complications and ensure proper tracking. However, they will not score any rating nor contribute to the tournament players count if they have not played at least one round.
...
1. No pair of players repeat their predator-prey relationship. This is mandatory, by the [VEKN Tournament rules](/document/tournament-rules.html#H3-1-2-preliminary-rounds-seating).
2. No pair of players share a table through all rounds.
3. Available VPs are equitably distributed.
4. No pair of players share a table more often than necessary.
5. A player does not sit in the fifth seat more than once.
6. No pair of players repeat the same relative position\*.
7. A player does not play in the same seat position.
...
After two preliminary rounds, organizers can either proceed with more rounds, or with a finals. The finals will select the top five players in terms of Game win (GW), Victory Points (VP), and Tournament Points (TP), as per the [VEKN tournament rules](/document/tournament-rules.html#H3-7-determining-a-game-winner).
...
Finals follow a specific seating procedure, indicated in the [VEKN tournament rules](/document/tournament-rules.html#H3-1-3-final-round-seating). Organizers and judges should alter the table seating to reflect the actual seating after this procedure has taken place.
...
Throughout an event, organizers and judges can sanction players in case of any issue, whether they fail to follow the game rules, tournament rules, or ethical requirements of the VEKN. Sanctions can be added by clicking the info button next to a players' name anywhere in the console.
