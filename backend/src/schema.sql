...
-- The legacy /tournament/<uid>/display.html redirect.
CREATE INDEX IF NOT EXISTS idx_objects_tournament_archon
ON objects(("full"->'external_ids'->>'archon'))
WHERE type = 'tournament' AND "full"->'external_ids'->>'archon' IS NOT NULL;
