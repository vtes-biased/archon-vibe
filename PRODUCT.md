...
- **Members**: profiles (name, country, city, socials, contact), avatar upload (client crop + server compress), VEKN ID claim/sponsor/link/abandon/force-abandon, roles (IC, NC, Prince, Judge, Sheriff, Rulemonger, Ethics, PTC, Playtester, DEV), same-country user merge, cooptation tracking, privacy-filtered directory.
