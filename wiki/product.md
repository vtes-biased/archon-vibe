...
link import strips the deckbuilder's noise from it ([vekn](vekn.md#outbound)); a
...
list filters including National/Continental championship rank, a start-date
window and several countries at once.
