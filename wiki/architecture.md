...
every tournament, and again from any device snapshot go-online or sync-offline
lands ([hazards](hazards.md)). The record is not soft-deleted, since the next sync
