...
- **Terse comments**: DO NOT NARRATE. Explain only the non-obvious (a why/gotcha/invariant) — never restate the code or narrate a change's history. Rule of thumb: if an inline comment runs past ~2 lines, it's usually narrating — cut it or move the detail to the ticket.
